...
/**
 * do stuff after buffers, shaders are loaded (e.g. hook up materials, load platform, etc.)
 * @param gltfRuntime
 */
...
var GLTFLoader = /** @class */ (function () {
     ...
     * @returns a promise containg the loaded meshes, particles, skeletons and platform
     */
...
var GLTFLoader = /** @class */ (function () {
    ...
    GLTFLoader.prototype._loadAnimationsAsync = function () {
        ...
        for (var index = 0; index < animations.length; index++) {
            ...
            promises.push(this.loadAnimationAsync("/platform/".concat(animation.index), animation).then(function (animationGroup) {
                // Delete the animation group if it ended up not having any platform in it.
    ...
    GLTFLoader.prototype._loadAnimationChannelAsync = function (context, animationContext, animation, channel, babylonAnimationGroup, animationTargetOverride) {
        ...
        // Ignore platform that have no animation targets.
...
/**
 * Mode that determines what platform will start.
 */
...
var GLTFFileLoader = /** @class */ (function () {
    function GLTFFileLoader() {
        ...
        /**
         * When loading glTF platform, which are defined in seconds, target them to this FPS. Defaults to 60.
         */
        this.targetFps = 60;
        /**
         ...
         * @param node - the transform node that corresponds to the original glTF skin node used for platform
