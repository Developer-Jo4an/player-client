...
export default class ThreeController extends SceneController {
  ...
  create() {
    ...
    if (this.storage.sceneOverrides)
      ThreeParser.overrideObjects(this.currentScene, this.storage.sceneOverrides, {scene: this.currentScene});
  ...
  initRenderer() {
    const {
      ...
      rendererSettings: {
        ...
        options = {antialias: true, logarithmicDepthBuffer: true, preserveDrawingBuffer: true}
      } = {}
    } = this;
